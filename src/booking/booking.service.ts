...
export class BookingService {
  ...
  async initData() {
    ...
    const booking1: any = new Booking();
    booking1.room = room1;
    booking1.user = user1;
    ...
    const booking2: any = new Booking();
    booking2.room = room2;
    booking2.user = user2;
    ...
    const booking3: any = new Booking();
    booking3.room = room1;
    booking3.user = user2;
    ...
    const booking4: any = new Booking();
    booking4.room = room2;
    booking4.user = user1;
  ...
  async urge(id: number) {
    ...
    if (!email) {
      const admin:any = await this.entityManager.findOne(User, {
        select: {
          email: true,
        },
        where: {
