...
export class UserController {
  ...
  private async loginHandler(loginUser: LoginUserDto, isAdmin: boolean) {
  ...
  async adminLogin(@Body() loginUser: LoginUserDto) {
    return this.loginHandler(loginUser, true);
  }
  ...
  async info(@UserInfo('userId') userId: number) {
    const user: any = await this.userService.findUserDetailById(userId);
